...
Marker.prototype.setDeselected = function(marker) {
    ...
    if (marker.animationGroupIdle === null) {
        ...
        /*
            There are two types of AR.AnimationGroups. Parallel animations are running at the same time, sequentials
            are played one after another. This example uses a parallel AR.AnimationGroup.
         */
...
Marker.prototype.isAnyAnimationRunning = function(marker) {
    ...
    if (marker.animationGroupIdle === null || marker.animationGroupSelected === null) {
        ...
        return (marker.animationGroupIdle.isRunning() === true) ||
