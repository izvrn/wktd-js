var Solar = {
    ...
    init: function() {
        ...
        var sun = {
            ...
            size: sunSize,
            description: "The Sun is the star at the center of the Solar System. It is almost perfectly spherical" +
                " and consists of hot plasma interwoven with magnetic fields.",
        ...
        var mercury = {
            ...
            size: mercurySize,
            description: "Is the innermost planet in the Solar System. It is also the smallest, and its orbit is" +
                " the most eccentric (that is, the least perfectly circular).",
        ...
        var venus = {
            ...
            size: venusSize,
            description: "Is named after the Roman goddess of love and beauty. After the Moon, it is the brightest" +
                " natural object in the night sky, bright enough to cast shadows.",
        ...
        var earth = {
            ...
            size: earthSize,
            description: "Is the third planet from the Sun, and the densest and fifth-largest of the eight planets" +
                " in the Solar System. It is sometimes referred to as the world, the Blue Planet, Terra.",
        ...
        var mars = {
            ...
            size: marsSize,
            description: "Is named after the Roman god of war, it is often described as the &quot;Red Planet&quot;," +
        ...
        var jupiter = {
            ...
            size: jupiterSize,
            description: "Is the largest planet within the Solar System. It is a gas giant with mass one-thousandth" +
                " that of the Sun but is two and a half times the mass of all the other planets in our Solar System" +
                " combined.",
        ...
        var saturn = {
            ...
            size: saturnSize,
            description: "Is the second largest planet in the Solar System, after Jupiter. Named after the Roman" +
                " god Saturn. Saturn is a gas giant with an average radius about nine times that of Earth.",
        ...
        var uranus = {
            ...
            size: uranusSize,
            description: "It has the third-largest planetary radius and fourth-largest planetary mass in the Solar" +
                " System. It is named after the ancient Greek deity of the sky Uranus.",
        ...
        var neptun = {
            ...
            size: neptunSize,
            description: "Is the farthest planet from the Sun in the Solar System. It is the fourth-largest planet" +
        ...
        var pluto = {
            ...
            size: plutoSize,
            description: "Originally classified as the ninth planet from the Sun, Pluto was recategorized as a" +
                " dwarf planet and plutoid owing to the discovery that it is only one of several large bodies within" +
                " the Kuiper belt.",
        ...
        for (var i = 0; i < this.planetsInfo.length; i++) {
            ...
            if (i > 0) {
                ...
                var sunHackAnim = new AR.PropertyAnimation(
                    this.planetsInfo[i].location, 'northing', 10000, 10000, 1000, {
    ...
    animate: function(planet) {
        ...
        var roundingTime = distance;

        var northSouth1 = new AR.PropertyAnimation(relLocation, 'northing', distance * 1, 0, roundingTime, {
            type: AR.CONST.EASING_CURVE_TYPE.EASE_IN_SINE
        });
        var eastWest1 = new AR.PropertyAnimation(relLocation, 'easting', 0, distance * 1, roundingTime, {
            type: AR.CONST.EASING_CURVE_TYPE.EASE_OUT_SINE
        });

        var northSouth2 = new AR.PropertyAnimation(relLocation, 'northing', 0, distance * -1, roundingTime, {
            type: AR.CONST.EASING_CURVE_TYPE.EASE_OUT_SINE
        });
        var eastWest2 = new AR.PropertyAnimation(relLocation, 'easting', distance * 1, 0, roundingTime, {
            type: AR.CONST.EASING_CURVE_TYPE.EASE_IN_SINE
        });

        var northSouth3 = new AR.PropertyAnimation(relLocation, 'northing', distance * -1, 0, roundingTime, {
            type: AR.CONST.EASING_CURVE_TYPE.EASE_IN_SINE
        });
        var eastWest3 = new AR.PropertyAnimation(relLocation, 'easting', 0, distance * -1, roundingTime, {
            type: AR.CONST.EASING_CURVE_TYPE.EASE_OUT_SINE
        });

        var northSouth4 = new AR.PropertyAnimation(relLocation, 'northing', 0, distance * 1, roundingTime, {
            type: AR.CONST.EASING_CURVE_TYPE.EASE_OUT_SINE
        });
        var eastWest4 = new AR.PropertyAnimation(relLocation, 'easting', distance * -1, 0, roundingTime, {
            type: AR.CONST.EASING_CURVE_TYPE.EASE_IN_SINE
        });
